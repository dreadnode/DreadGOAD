...
- Practice lab(s) :
    ...
    - [GOAT — Game of Agent Trust](GOAT.md): 6 Linux VMs on Azure or AWS with interconnected applications, databases, development platforms, storage, and infrastructure services for offensive AI agent testing
