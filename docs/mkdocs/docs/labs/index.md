...
- Practice lab(s) :
    ...
    - [GOAT — Game of Agent Trust](SCOPE-RANGE.md): 6 Linux VMs on Azure with interconnected applications, databases, development platforms, storage, and infrastructure services for offensive AI agent testing
