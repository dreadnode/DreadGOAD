...
dependency "network" {
  ...
  mock_outputs = {
    ...
    location            = "centralus"
    vnet_id             = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/goat-dev-goat-rg/providers/Microsoft.Network/virtualNetworks/goat-dev-goat-vnet"
