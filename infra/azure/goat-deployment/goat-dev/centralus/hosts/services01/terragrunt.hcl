...
dependency "network" {
  config_path                             = "../../network"
  mock_outputs                            = { resource_group_name = "goat-dev-goat-rg", location = "centralus", private_subnet_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/goat-dev-goat-rg/providers/Microsoft.Network/virtualNetworks/goat-dev-goat-vnet/subnets/goat-dev-goat-private" }
  mock_outputs_allowed_terraform_commands = ["init", "validate", "plan"]
}
dependency "access" {
  config_path                             = "../../access"
  mock_outputs                            = { public_key_openssh = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGFiHzcUOlS2dr9JBEmZ97cCtKMCr0gSpYEMfwukjeoc goat-plan-mock" }
  mock_outputs_allowed_terraform_commands = ["init", "validate", "plan"]
}
inputs = {
  ...
  tags                 = { Project = "DreadGOAD", Range = "GOAT", Deployment = "goat-deployment", Role = local.host.role }
}
