"""Consistency tests for the connected GOAT seed fixtures."""
...
POSTGRES_SEED = ROOT / "ansible/roles/goat_data/files/init-postgres.sh"
MARIADB_SEED = ROOT / "ansible/roles/goat_data/files/init-mariadb.sql"
MONGO_SEED = ROOT / "ansible/roles/goat_data/files/init-mongo.js"
VALIDATION_MANIFEST = ROOT / "ad/GOAT/data/validation.json"
KALI_SMOKE_TEST = ROOT / "ansible/roles/goat_kali/files/goat-smoke.sh"
AZURE_INVENTORY = ROOT / "ad/GOAT/providers/azure/inventory"
AWS_INVENTORY = ROOT / "ad/GOAT/providers/aws/inventory"
DNS_OPTIONS = (
    ROOT / "ansible/roles/goat_services/templates/named.conf.options.j2"
)
SERVICES_PLAYBOOK = ROOT / "ansible/playbooks/goat-services.yml"
VENDOR_CONTACTS = ROOT / "ansible/roles/goat_storage/files/vendor-contacts.csv"
...
class GOATSeedFixtureTests(unittest.TestCase):
    ...
    def test_live_validator_expects_expanded_fixtures(self) -> None:
        ...
        self.assertIn("goat-seed-v2", VALIDATION_MANIFEST.read_text(encoding="utf-8"))
