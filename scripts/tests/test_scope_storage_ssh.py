...
TASKS_PATH = ROOT / "ansible/roles/scope_range_storage/tasks/main.yml"


class ScopeStorageSSHTests(unittest.TestCase):
    ...
    def test_reconcile_is_immediate_unconditional_and_fail_safe(self) -> None:
        ...
        self.assertEqual(
            config_task.get("register"), "scope_range_sftp_sshd_config"
        )
