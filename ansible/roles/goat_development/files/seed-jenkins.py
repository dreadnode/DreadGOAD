...
AUTH = ("poseidon", "GOATJenkins2026!")
JOB_NAME = "kraken-nightly-export"
JOB_CONFIG = pathlib.Path("/opt/goat/development/kraken-nightly-export.xml")
GARAGE_ARTIFACT_ROOT = "http://s3.range.test:3900/build-artifacts/kraken/0.1.0"
GARAGE_AUTH = (
    "GKGOAT2026ACCESS",
    "GOATGarageSecretKey2026GOATGarageSecretKey2026",
)
...
def wanted = [
  ["goat-gitea", "poseidon", "GOATGitea2026!", "Synthetic Gitea account"],
  ["goat-garage", "GKGOAT2026ACCESS", "GOATGarageSecretKey2026GOATGarageSecretKey2026", "Synthetic Garage access key"]
]
wanted.each { item ->
...
def successful_seed_build_exists() -> bool:
    ...
    try:
        ...
        return False
    if manifest.get("seed_version") != "goat-seed-v2":
        return False
